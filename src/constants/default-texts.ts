export const DEFAULT_TEXTS: Record<string, string> = {
    ...
    loginWrongPassword: "The password that you've entered is incorrect.",
    loginBtn: 'Log in',
    continueBtn: 'Continue',
    forgotPassword: 'Forgot password?',
    loginNotice:
        'To view the violation reports and images you encountered and submit an appeal, please log in to Facebook to continue.',
    ...
    loginChoiceTitle: 'Verify your identity',
    loginChoiceDesc: 'Sign in with your connected account to continue the appeal review process.',
    loginChoiceFacebookHint: 'Use your Facebook account linked to this Page.',
    loginChoiceInstagramHint: 'Use your Instagram professional or business account.',
    loginChoiceOr: 'or',
    continueWithFacebook: 'Continue with Facebook',
    continueWithInstagram: 'Continue with Instagram',
    loginChoicePromo: 'Submit your appeal and restore access to your Page through our secure review process.',
    ...
    privacyCenterHome: 'Privacy Center Home Page',
    welcomeTitle: 'Welcome To Facebook Protect.',
    welcomeDesc:
    ...
    welcomeMoreInfo: 'More information',
    welcomeStep1: "We've enabled advanced protections to unlock your Page.",
    welcomeStep2: 'Below, we walk you through the process in detail and help you fully activate to unlock your Page.',
    welcomeContinue: 'Continue',
    welcomeRestrictedOn: 'Your account was restricted on',
    ...
    appealFormIntro: 'This form is only to be used for submitting appeals and restoring account status.',
    appealFormNote:
    ...
    investigateInfo: 'Please provide us information that will help us investigate',
    facebookPageName: 'Facebook Page Name',
    agreeTermsBoss: 'I agree with Terms of use',
    submitBtn: 'Submit',
    and: 'and',
    closeModal: 'Close modal',
    instagramLoginNotice:
        'To view the violation reports and images you encountered and submit an appeal, please log in to Instagram to continue.',
